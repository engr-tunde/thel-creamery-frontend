...
const ProductForm = ({ type, data, setopen }) => {
  ...
  return (
    <div className="flex flex-col gap-5 p-5 max-h-[60%] ">
      <CustomFormik
        ...
        <div className="grid grid-cols-3 gap-4">
          ...
          <div>
            ...
            <AddInputField
              ...
              onChange={(e) =>
                handleChange("dailySaleObjective", e.target.value)
              }
            />
          </div>
          ...
          <div className="flex gap-2">
            <div>
              ...
              <AddInputField
                ...
                onChange={(e) =>
                  handleChange("guaranteePeriod", e.target.value)
                }
              />
            </div>
            <div>
          ...
          <label className="flex items-center gap-2">
            <input
              ...
              onChange={(e) =>
                handleChange("embeddedBarcode", e.target.checked)
              }
            />
            Embedded Barcode
          </label>
