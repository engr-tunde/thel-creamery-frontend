      ...
      return (
        <div className="w-full mx-auto p-6 bg-white rounded-xl shadow-md">
            ...
            >
                <Form className="grid grid-cols-2 md:grid-cols-6 gap-4 mb-6">
                    <div className="col-span-2">
                        <label className="text-xs font-semibold" htmlFor="date">Date</label>
                        <Field 
                        name="date" 
                        type="date" 
                        value={date}
                    ...
                    <div className="col-span-2">
                        <label className="text-xs font-semibold" htmlFor="referenceNo">Reference No</label>
                        <Field 
                        name="referenceNo" 
                        type="number" 
                        className="text-sm w-full border border-[1px] px-3 border-gray-200 bg-gray-100/90 focus:border-purple-600 outline-none text-proPurple rounded-md p-2 mb-4"
                    ...
                    <div className="col-span-2">
                        <label className="text-xs font-semibold" htmlFor="customer">Customer</label>
                        <Field 
                        name="customer"
                        as="select" 
                        value={customer}
                        ...
                        >
                            <option value="Walk in (320000034567)">Walk in (320000034567)</option>
                    ...
                    <div className="col-span-2">
                        <label className="text-xs font-semibold" htmlFor="warehouse">Warehouse</label>
                        <Field 
                        name="warehouse" 
                        as="select" 
                        value={warehouse}
                    ...
                    <div className="col-span-2">
                        <label className="text-xs font-semibold" htmlFor="biller">Biller</label>
                        <Field 
                        name="biller" 
                        type="text" 
                        className="text-sm w-full border border-[1px] px-3 border-gray-200 bg-gray-100/90 focus:border-purple-600 outline-none text-proPurple rounded-md p-2 mb-4"
                    ...
                    <div className="col-span-2 lg:col-span-1">
                        <label className="text-xs font-semibold" htmlFor="currency">Currency</label>
                        <Field 
                        name="currency" 
                        as="select" 
                        value={currency}
                    ...
                    <div className="col-span-2 lg:col-span-1">
                        <label className="text-xs font-semibold" htmlFor="exchangeRate">Exchange Rate</label>
                        <Field 
                        name="exchangeRate" 
                        type="text" 
                        className="text-sm w-full border border-[1px] px-3 border-gray-200 bg-gray-100/90 focus:border-purple-600 outline-none text-proPurple rounded-md p-2 mb-4"
                    ...
                    <div className="col-span-6 mb-6 flex flex-col gap-1 items-start rounded-md overflow-hidden">
                        <label className="text-xs font-semibold" htmlFor="selectProduct">Select Product</label>
            ...
            >
                <Form className="grid grid-cols-2 md:grid-cols-6 gap-4 mb-6">
                    <div className="col-span-2">
                        <label className="text-xs font-semibold" htmlFor="orderTax">Order Tax</label>
                        <Field 
                        name="orderTax" 
                        type="number" 
                        className="text-sm w-full border border-[1px] px-3 border-gray-200 bg-gray-100/90 focus:border-purple-600 outline-none text-proPurple rounded-md p-2 mb-4"
                    ...
                    <div className="col-span-2">
                        <label className="text-xs font-semibold" htmlFor="orderDiscountType">Order Discount Type</label>
                        <Field 
                    ...
                    <div className="col-span-2">
                        <label className="text-xs font-semibold" htmlFor="orderDiscountValue">Order Discount Value</label>
                        <Field 
                    ...
                    <div className="col-span-2">
                        <label className="text-xs font-semibold" htmlFor="shippingCost">Shipping Cost</label>
                        <Field 
                        name="shippingCost" 
                        type="number"
                    ...
                    <div className="col-span-2">
                        <label className="text-xs font-semibold flex items-center gap-2" htmlFor="attachDocument">
                    ...
                    <div className="col-span-2">
                        <label className="text-xs font-semibold" htmlFor="saleStatus">Sale Status</label>
                        <Field 
                        name="saleStatus" 
                        as="select"
                        value={saleStatus}
                    ...
                    <div className="col-span-2">
                        <label className="text-xs font-semibold" htmlFor="paymentStatus">Payment Status</label>
                        <Field 
                        name="paymentStatus" 
                        as="select"
                        value={paymentStatus}
                    ...
                    <div className="col-start-1 col-span-3">
                        <label className="text-xs font-semibold" htmlFor="saleNote">Sale Note</label>
                        <Field 
                        name="saleNote" 
                        as="textarea"
                        value={saleNote}
                    ...
                    <div className="col-span-3">
                        <label className="text-xs font-semibold" htmlFor="staffNote">Staff Note</label>
                        <Field 
                        name="staffNote" 
                        as="textarea"
                        value={staffNote}
