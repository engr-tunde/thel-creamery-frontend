...
// import { expenseRowData, expenseTableCol } from "../../data/expenseData";
// import ExpenseTable from "../../component/global/ExpenseTable";
...
//         <div className="flex items-center gap-2 py-2 px-3 rounded-sm bg-[#17a2b8] text-white cursor-pointer">
//           <FaPlus />
//           <span>Add Expense Category</span>
//         </div>
//         <div className="flex items-center gap-2 py-2 px-3 rounded-sm bg-[#fa7474] text-white cursor-pointer">
//           <FaPlus />
...
//       {/* Table */}
//       <ExpenseTable
//         expenseTablecol={expenseTableCol}
//         expenseTableRowData={expenseRowData}
  ...
  return (
    <div className="w-full p-6">
      ...
      <div className="flex gap-4">
        ...
        <div
          className="flex items-center gap-2 py-2 px-3 rounded-sm bg-[#fa7474] text-white cursor-pointer"
          onClick={() => {
