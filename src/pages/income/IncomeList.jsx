...
import { incomeListRowData, incomeListTableCol } from "../../data/incomeData";

import IncomeListTable from "../../component/global/IncomeListTable";
import IncomeListFormModal from "../../component/income/IncomeListFormModal";
...
const IncomeList = () => {
  ...
  return (
    <div className="w-full p-6">
      ...
      {/* Table */}
      <IncomeListTable
        incomeListTableCol={incomeListTableCol}
        incomeListRowData={incomeListRowData}
